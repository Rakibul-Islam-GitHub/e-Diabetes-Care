...
<input type="button" name="profile-update-btn" data-toggle="modal" data-target="modal-toggle"class="modalupdate btn btn-primary" value="update">
...
<label>Your Picture</label>
        ...
        <!-- end of doctor update form -->
          ...
          <div id="appointment-div">
            <div class="appointment-btn">
              <input type="button" data-toggle="modal" data-target="modal-toggle"class="modalsetappointment btn" name="appointment-update-btn" value="Set">
              <input type="button" class="btn" name="" value="update">
            </div>
            <div class="appointment-div-all">
     ...
     <tr>
       ...
       <td>8</td>
                 ...
                 <div class="modal setmodal">
                   <div class="modal-overlay modal-toggle"></div>
                   <div class="modal-wrapper modal-transition">
                     <div class="modal-header">
                       <button class="modal-close modal-toggle modalsetappointment">X</button>
                        <h2 class="modal-heading">Update your profile</h2>
                     </div>
                 ...
                 <div class="modal-content">
                   <form method="POST" action="" ENCTYPE="multipart/form-data" action="" id="form1">
                 <input type="checkbox" id="saturday" name="day1" value="">
                  <label for="saturday"> Saturday</label>
                 <input type="text" name="day1-time" value=""><br><br>
                 <input type="checkbox" id="sunday" name="day2" value="">
                    <label for="sunday"> Sunday</label>
                    <input type="text" name="day2-time" value=""><br><br>
                 <input type="checkbox" id="monday" name="day3" value="">
                    <label for="monday"> Monday</label>
                    <input type="text" name="day3-time" value=""><br><br>
                 <input type="checkbox" id="tuesday" name="day4" value="">
                  <label for="tuesday">Tuesday</label>
                  <input type="text" name="day4-time" value=""><br><br>
                 <input type="checkbox" id="wednsday" name="day5" value="">
              <label for="wednesday"> Wednesday</label>
              <input type="text" name="day5-time" value=""><br><br>
                 <input type="checkbox" id="thrusday" name="day6" value="">
                <label for="thrusday">Thrusday</label>
                <input type="text" name="day6-time" value=""><br><br>
                 <input type="checkbox" id="friday" name="day7" value="">
                <label for="friday">Friday</label>
                <input type="text" name="day7-time" value=""><br><br>
      ...
      $('.modalsetappointment').on('click', function(e) {
        e.preventDefault();
        $('.setmodal').toggleClass('is-visible');
      });
